                        ...
                        <div class="col">
                            ...
                            <div class="overflow-hidden opacity-8 mb-1">
                                <h2 class="text-color-light line-height-6 line-height-md-2 text-5 text-md-6 positive-ls-3 mb-0 appear-animation"
                                    data-appear-animation="maskUp" data-appear-animation-delay="250">A Very
                                    Personal Approach to Every Client</h2>
                            </div>
                            <div class="overflow-hidden opacity-6 mb-5">
                                <p class="text-color-light text-3-5 mb-0 appear-animation"
                                    data-appear-animation="maskUp" data-appear-animation-delay="500">Elegant
                            ...
                            <a href="#start" data-hash data-hash-offset="0" data-hash-offset-lg="140"
                                ...
                                data-appear-animation="fadeInUpShorterPlus" data-appear-animation-delay="750">ΔΕΙΤΕ ΤΙΣ ΥΠΗΡΕΣΙΕΣ ΜΑΣ</a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row align-items-center justify-content-end h-100">
                        <div class="col text-end">
                            ...
                            <a href="#start" data-hash data-hash-offset="0" data-hash-offset-lg="140"
                                ...
                                data-appear-animation="fadeInUpShorterPlus" data-appear-animation-delay="750">ΣΧΕΤΙΚΑ ΜΕ ΕΜΑΣ</a>
                        </div>
                    </div>
                </div>
            </div>
